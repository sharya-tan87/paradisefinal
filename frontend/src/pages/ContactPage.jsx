            ...
            <main className="flex-grow -mt-[88px]">
                    ...
                    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 xl:px-20 w-full relative z-10">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            <div className="relative flex justify-center lg:justify-start lg:h-[700px] items-center order-2 lg:order-1">
                                <img
                                    src={`${import.meta.env.BASE_URL}img/paradise_contact.svg`}
                                    alt="Contact Us"
                    ...
                    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                            ...
                            <div className="space-y-6">
                                {/* Address Card */}
                                <div className="bg-brand-light/50 rounded-3xl p-8 flex flex-col md:flex-row gap-6 md:items-start">
                                    ...
                                    <div className="space-y-4">
                                        <h3 className="text-2xl font-bold text-gradient-brand flex items-center gap-2">
                                ...
                                <div className="bg-brand-light/50 rounded-full py-4 px-8 flex items-center gap-6 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                {/* Opening Hours Card */}
                                <div className="bg-brand-light/50 rounded-3xl p-8">
                                    <div className="flex items-center gap-4 mb-6">
                                        <div className="w-16 h-16 rounded-full border-2 border-brand text-brand flex items-center justify-center bg-white">
                                            <Clock className="w-8 h-8" />
                                        </div>
                                        <h3 className="text-2xl font-bold text-gradient-brand">{t('contact.hours')}</h3>
                                    </div>

                                    <div className="space-y-4 text-lg text-text-secondary pl-4 md:pl-20">
                                        <div className="flex flex-col md:flex-row md:items-center gap-2">
                                            <span className="font-semibold text-text-secondary w-48">{t('contact.open_tue_sun')}:</span>
                                            <span>10:00 – 20:00</span>
                                        </div>
                                        <div className="flex flex-col md:flex-row md:items-center gap-2">
                                            <span className="font-semibold text-text-secondary w-48">{t('contact.monday')}:</span>
                                            <span>{t('contact.closed')}</span>
                                        </div>
                                        <div className="flex flex-col md:flex-row md:items-center gap-2">
                                            <span className="font-semibold text-text-secondary w-48">{t('contact.public_holidays')}:</span>
                            ...
                            {/* Right Column: Map */}
                            <div className="h-full min-h-[500px] w-full bg-brand-light/50 rounded-3xl overflow-hidden shadow-lg border border-brand-light">
                                <iframe
                ...
                <section className="py-20 md:py-32 bg-gradient-to-br from-white via-primary-50 to-white relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center relative z-10">
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gradient-brand mb-6 leading-tight">
                            {t('contact.cta_title')}
                        </h2>
