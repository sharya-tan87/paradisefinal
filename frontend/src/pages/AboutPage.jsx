    ...
    return (
        <div className="min-h-screen bg-white font-prompt flex flex-col overflow-x-hidden">
            ...
            <main className="flex-grow -mt-[88px]">
                    ...
                    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 xl:px-20 w-full relative z-10">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            <div className="text-center lg:text-left space-y-8 animate-fade-in-up order-1 lg:order-2">
                                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.4] text-gradient-brand py-2">
                                    {t('about.hero.title_part1')} <br />
                                    {t('about.hero.title_part2')} <br />
                                    {t('about.hero.title_part3')}
                                </h1>
                ...
                {/* Vision Section */}
                <section className="py-24 md:py-32 lg:py-40 bg-gradient-to-b from-white to-brand-light/30 relative overflow-hidden">
                    ...
                    <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
                        ...
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gradient-brand mb-6">
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="text-center">
                                <h3 className="text-2xl md:text-3xl font-bold text-gradient-brand mb-6 leading-tight">
                ...
                <section id="team" className="py-24 md:py-32 lg:py-40 bg-white">
                    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                        <div className="text-center mb-20">
                            <h2 className="text-3xl md:text-4xl font-bold text-gradient-brand mb-6">
                                {t('about.team.title')}
                            </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
                            ...
                            {[1, 2, 3, 4].map((id) => (
                                <div key={id} className="bg-white rounded-xl border border-primary-100 shadow-soft p-6 text-center hover:shadow-lg transition-all duration-300">
                                    <div className="w-32 h-32 rounded-full bg-primary-100 flex items-center justify-center mx-auto mb-6 text-2xl font-bold text-brand-dark border-4 border-white shadow-sm">
                                        {['SP', 'EC', 'KS', 'DT'][id - 1]}
                                    </div>
                                    <h3 className="text-xl font-semibold text-gradient-brand font-prompt mb-1">
                ...
                <section id="standard" className="py-24 md:py-32 lg:py-40 bg-gradient-to-b from-white to-brand-light/20">
                    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                        {/* Section Header */}
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gradient-brand mb-4">
                                {t('about.standards.title')}
                            </h2>
                            <p className="text-lg text-text-secondary max-w-2xl mx-auto">
                                {t('about.standards.subtitle')}
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10 mb-16">
                            ...
                            <div className="bg-white rounded-2xl border border-brand-light shadow-lg p-8 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
                                ...
                                <h3 className="text-xl font-bold text-gradient-brand mb-4 text-center">
                                    {t('about.standards.sterilization.title')}
                                </h3>
                                <p className="text-text-secondary text-center leading-relaxed">
                                    {t('about.standards.sterilization.desc')}
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl border border-brand-light shadow-lg p-8 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
                                <div className="flex justify-center mb-6">
                                    <div className="h-20 w-20 rounded-full bg-brand-light/50 flex items-center justify-center">
                                        <FlaskConical className="h-10 w-10 text-brand" />
                                    </div>
                                </div>
                                <h3 className="text-xl font-bold text-gradient-brand mb-4 text-center">
                                    {t('about.standards.technology.title')}
                                </h3>
                                <p className="text-text-secondary text-center leading-relaxed">
                                    {t('about.standards.technology.desc')}
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl border border-brand-light shadow-lg p-8 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
                                ...
                                <h3 className="text-xl font-bold text-gradient-brand mb-4 text-center">
                                    {t('about.standards.service.title')}
                                </h3>
                                <p className="text-text-secondary text-center leading-relaxed">
                                    {t('about.standards.service.desc')}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-r from-brand to-brand-dark rounded-2xl p-10 md:p-12 text-center shadow-2xl">
                            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                                {t('about.standards.cta.title')}
                            </h3>
                            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
                                {t('about.standards.cta.subtitle')}
                            </p>
                            <Link
                                to="/booking"
                            ...
                            >
                                ...
                                <span>{t('about.standards.cta.button')}</span>
                            </Link>
                        </div>
                    </div>
                </section>
